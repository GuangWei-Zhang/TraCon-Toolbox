# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 12:33:38 2019
...
while(True):
    ...
    dist = frame3[x_start:x_stop,y_start:y_stop]
    ...
    #whisker_index = np.mean(mod)
    whisker_index = np.mean(dist)
    # apply thresholding
    ...
    line = str(i)+','+str(whisker_index)+'\n'
    with open(root+r'_lick_instensity_4.csv','a') as f:
        f.write(line)
