# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 13:43:43 2019
...
cv2.destroyAllWindows()       
        #print(posNp)
x_0,y_0 = posList[0]
posList.append([x_0+box_length,y_0])
posList.append([x_0,y_0+box_width])
posList.append([x_0+box_length,y_0+box_width])
...
for fullFileName in root1.tk.splitlist(filez):
    ...
    out = cv2.VideoWriter(root+'_GeometricallyTransformed.mp4',fourcc,25,(box_length,box_width))
    while True:
        ret, img_raw =cap.read() #start capture images from webcam
        if ret == False:
            break
