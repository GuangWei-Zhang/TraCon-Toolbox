# -*- coding: utf-8 -*-
"""
Created on Sat Aug 17 18:50:13 2019
...
# pos_frame = cap.get(cv2.cv.CV_CAP_PROP_POS_FRAMES)
    ...
    #interval_step_y =(x_stop-x_start)/5
        ...
        x_start_region4Counting = 240
        x_stop_region4Counting = 480
        
        y_start_region4Counting = 0
        y_stop_region4Counting = 240In [3]: runfile('C:/Users/zhanglab/Dropbox/coding/Batch_SingleChamber_travellingDistance.py', wdir='C:/Users/zhanglab/Dropbox/coding')
F:/TraCon/Novel_obj/WIN_20190915_17_11_44_Pro_GeometricallyTransformed_1
0.30
F:/TraCon/Novel_obj/WIN_20190915_17_43_07_Pro_GeometricallyTransformed_1
0.80
Processing Done!
        ...
        if len(contours) > 0:
            ...
            try:
                ...
                if radius >10:
                    ...
                    #out.write(img_raw)
                    line = str(center[0])+','+str(center[1])+','+str(d_dist)+'\n'
