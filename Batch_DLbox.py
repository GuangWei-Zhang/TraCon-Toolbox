...
# pos_frame = cap.get(cv2.cv.CV_CAP_PROP_POS_FRAMES)
  ...
  #print(np.mean(contours))
        f= open(root+r'_trackTrace.csv','a')
        ...
        if len(contours) > 0:
            ...
            try:
                ...
                if radius >10:
                    ...
                    cv2.putText(img_raw,'Detected',(50,50),font,1,(255,0,0),2,cv2.LINE_AA)
                    #print(temp_percent)
                    ...
                    cv2.putText(img_raw,'Not Found',(50,50),font,1,(255,0,0),2,cv2.LINE_AA)
                    cv2.imshow(r'img',img_raw)
                    out.write(img_raw)
                    line = str(0)+'\n'
