  ...
  ####
   ...
   #     img_ROI = img_raw.copy()
    ...
    if i==1:
        ...
        #region4Counting = cv2.selectROI(img_raw)
    ...
    x_start_region4Counting = int(y_start+interval_step_x)
    x_stop_region4Counting = int(y_stop-interval_step_x)
    
    y_start_region4Counting = int(x_start+interval_step_y)
    y_stop_region4Counting = int(x_stop-interval_step_y)
    ...
    if len(contours) > 0:
        ...
        try:
            ...
            if radius >10:
                ...
                cv2.putText(img_raw,'percent'+temp_percent,(50,50),font,1,(0,0,255),2,cv2.LINE_AA)
